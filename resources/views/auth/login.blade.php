...
<head>
  <meta charset="utf-8">
    ...
    <title>School Management System Admin - Log in </title>
							...
							<form action="{{route('login')}}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="hidden" id="role" name="role" class="form-control pl-15 bg-transparent text-white plc-white" value="student">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
